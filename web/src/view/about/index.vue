<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card>
          <div slot="header">Driving-School</div>
          <div>
            <el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <a href="https://github.com/">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/watchers/FlameMida/gin-vue-admin.svg?label=Watch"
                    alt=""
                  />
                </a>
              </el-col>
              <el-col :span="8">
                <a href="https://github.com/">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/stars/FlameMida/gin-vue-admin.svg?style=social"
                    alt=""/></a
              ></el-col>
              <el-col :span="8">
                <a href="https://github.com/">
                  <img
                    class="dom-center"
                    src="https://img.shields.io/github/forks/FlameMida/gin-vue-admin.svg?label=Fork"
                    alt=""/></a
              ></el-col>
            </el-row>
          </div>
