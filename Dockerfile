...
#copy go app
COPY --from=builder /go/src/Driving-school/gvadmin ./
COPY --from=builder /go/src/Driving-school/db.db ./
COPY --from=builder /go/src/Driving-school/config.yaml ./
COPY --from=builder /go/src/Driving-school/resource ./resource
