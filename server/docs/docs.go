    ...
    "paths": {
        ...
        "/coach/getCoachList": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "分页获取Coach列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CoachSearch"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "weather": {
                    "$ref": "#/definitions/config.Weather"
                },
                "zap": {
